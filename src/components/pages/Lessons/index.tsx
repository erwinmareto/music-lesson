...
const LessonsPage = () => {
  ...
  useDebounce(
    () => {
      const newParamsRemoved = removeSearchParams(searchParams, ['status', 'teacher', 'start']);
    ...
    <div className="container mx-auto p-2 md:p-10">
      <Card className="p-2 md:p-4">
        <div className="flex flex-wrap items-center gap-4 py-4">
          ...
          <SelectInput id="status" label="Status" options={LESSON_STATUS} value={status} onChange={handleStatus} />
          <DatePicker selectedDate={startDate} onSelectDate={setStartDate} label="Start Date" />
        </div>
        <ReactQuery
